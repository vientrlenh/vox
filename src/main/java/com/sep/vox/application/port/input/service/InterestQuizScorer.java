 ...
 * SYSTEM_ADMIN thêm chiều mới là hệ thống nhận ngay, không phải deploy lại (xem migration
 * V9__interest_dimension_catalog.sql để biết vì sao phải bỏ hằng số cứng).
 *
