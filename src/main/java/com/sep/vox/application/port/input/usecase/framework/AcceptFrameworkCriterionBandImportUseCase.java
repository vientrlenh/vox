...
@Service
public class AcceptFrameworkCriterionBandImportUseCase
        implements IUseCase<AcceptFrameworkCriterionBandImportCommand, AcceptFrameworkCriterionBandImportResponse> {
    ...
    public AcceptFrameworkCriterionBandImportUseCase(
    ...
    @Override
    @Transactional
    public AcceptFrameworkCriterionBandImportResponse execute(AcceptFrameworkCriterionBandImportCommand command) {
        ...
        if (session.getType() != ImportType.FRAMEWORK_CRITERION_BAND) {
        ...
        return new AcceptFrameworkCriterionBandImportResponse(
