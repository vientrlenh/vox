...
@Service
public class AcceptFrameworkResultBandImportUseCase
        implements IUseCase<AcceptFrameworkResultBandImportCommand, AcceptFrameworkResultBandImportResponse> {
    ...
    public AcceptFrameworkResultBandImportUseCase(
    ...
    @Override
    @Transactional
    public AcceptFrameworkResultBandImportResponse execute(AcceptFrameworkResultBandImportCommand command) {
        ...
        if (session.getType() != ImportType.FRAMEWORK_RESULT_BAND) {
        ...
        return new AcceptFrameworkResultBandImportResponse(
