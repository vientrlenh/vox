...
import com.sep.vox.application.port.input.command.PreviewFrameworkCriterionBandImportCommand;
...
@Service
public class PreviewFrameworkCriterionBandImportFromFileUseCase
        implements IUseCase<PreviewFrameworkCriterionBandImportCommand, PreviewFrameworkCriterionBandImportResponse> {
    ...
    public PreviewFrameworkCriterionBandImportFromFileUseCase(
    ...
    @Override
    @Transactional
    public PreviewFrameworkCriterionBandImportResponse execute(PreviewFrameworkCriterionBandImportCommand command) {
        ...
        frameworkVersionRepository.findById(command.versionId())
                .orElseThrow(() -> new NotFoundException("Không tìm thấy phiên bản khung năng lực."));

        ParseImportFileResult parsedResult = fileProcessingPort.parse(command.file(), ImportType.FRAMEWORK_CRITERION_BAND);
        ...
        ImportSession session = new ImportSession(
                null, null, ImportType.FRAMEWORK_CRITERION_BAND, command.file().fileName(),
                ...
                ImportSessionStatus.PREVIEWED, command.versionId(), expiresAt,
        ...
        return new PreviewFrameworkCriterionBandImportResponse(
