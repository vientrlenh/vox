...
@Service
public class PreviewFrameworkCriterionImportFromFileUseCase
        implements IUseCase<PreviewFrameworkCriterionImportCommand, PreviewFrameworkCriterionImportResponse> {
    ...
    public PreviewFrameworkCriterionImportFromFileUseCase(
    ...
    @Override
    @Transactional
    public PreviewFrameworkCriterionImportResponse execute(PreviewFrameworkCriterionImportCommand command) {
        ...
        ParseImportFileResult parsedResult = fileProcessingPort.parse(command.file(), ImportType.FRAMEWORK_CRITERION);
        ...
        ImportSession session = new ImportSession(
                null, null, ImportType.FRAMEWORK_CRITERION, command.file().fileName(),
        ...
        return new PreviewFrameworkCriterionImportResponse(
