...
@Service
public class PreviewFrameworkResultBandImportFromFileUseCase
        implements IUseCase<PreviewFrameworkResultBandImportCommand, PreviewFrameworkResultBandImportResponse> {
    ...
    public PreviewFrameworkResultBandImportFromFileUseCase(
    ...
    @Override
    @Transactional
    public PreviewFrameworkResultBandImportResponse execute(PreviewFrameworkResultBandImportCommand command) {
        ...
        ParseImportFileResult parsedResult = fileProcessingPort.parse(command.file(), ImportType.FRAMEWORK_RESULT_BAND);
        ...
        ImportSession session = new ImportSession(
                null, null, ImportType.FRAMEWORK_RESULT_BAND, command.file().fileName(),
        ...
        return new PreviewFrameworkResultBandImportResponse(
