...
@Service
public class ViewActiveFrameworksUseCase implements IUseCase<ViewFrameworksQuery, PageResult<FrameworkDto>> {

    private final FrameworkRepository frameworkRepository;

    public ViewActiveFrameworksUseCase(FrameworkRepository frameworkRepository) {
    ...
    public PageResult<FrameworkDto> execute(ViewFrameworksQuery input) {
        var result = frameworkRepository.findAllFrameworks(input.page(), input.size(), input.search(), true);
