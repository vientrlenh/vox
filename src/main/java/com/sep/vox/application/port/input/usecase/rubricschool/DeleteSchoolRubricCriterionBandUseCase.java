...
@Service
public class DeleteSchoolRubricCriterionBandUseCase implements IUseCase<DeleteSchoolRubricCriterionBandCommand, Void> {
    ...
    public DeleteSchoolRubricCriterionBandUseCase(
    ...
    @Override
    @Transactional
    public Void execute(DeleteSchoolRubricCriterionBandCommand command) {
