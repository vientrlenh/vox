...
import com.sep.vox.application.port.input.query.ViewSchoolRubricResultBandsQuery;
...
@Service
public class ViewSchoolRubricResultBandsUseCase implements IUseCase<ViewSchoolRubricResultBandsQuery, PageResult<RubricResultBandDto>> {
    ...
    public ViewSchoolRubricResultBandsUseCase(
    ...
    public PageResult<RubricResultBandDto> execute(ViewSchoolRubricResultBandsQuery query) {
        // 1. Xác thực User
        ...
        // 3. Lấy Version và kiểm tra tồn tại
        ...
        // 5. Query danh sách phân trang (Tận dụng lại hàm đã viết ở phần System)
