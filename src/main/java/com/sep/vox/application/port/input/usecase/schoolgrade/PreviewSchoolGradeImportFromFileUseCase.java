...
@Service
public class PreviewSchoolGradeImportFromFileUseCase
        implements IUseCase<PreviewSchoolGradeImportFromFileCommand, PreviewSchoolGradeImportResponse> {
    ...
    public PreviewSchoolGradeImportFromFileUseCase(
    ...
    @Override
    @Transactional
    public PreviewSchoolGradeImportResponse execute(PreviewSchoolGradeImportFromFileCommand input) {
        ...
        var parsed = fileProcessingPort.parse(input.file(), ImportType.SCHOOL_GRADE);
        ...
        return new PreviewSchoolGradeImportResponse(
            savedSession.getId(),
    ...
    private ImportSession createSession(
            PreviewSchoolGradeImportFromFileCommand input,
