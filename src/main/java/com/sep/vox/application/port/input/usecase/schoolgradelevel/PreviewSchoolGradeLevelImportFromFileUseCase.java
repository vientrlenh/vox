...
@Service
public class PreviewSchoolGradeLevelImportFromFileUseCase
        implements IUseCase<PreviewSchoolGradeLevelImportFromFileCommand, PreviewSchoolGradeLevelImportResponse> {
    ...
    public PreviewSchoolGradeLevelImportFromFileUseCase(
    ...
    @Override
    @Transactional
    public PreviewSchoolGradeLevelImportResponse execute(PreviewSchoolGradeLevelImportFromFileCommand input) {
        ...
        var parsed = fileProcessingPort.parse(input.file(), ImportType.SCHOOL_GRADE_LEVEL);
        ...
        return new PreviewSchoolGradeLevelImportResponse(
            savedSession.getId(),
    ...
    private ImportSession createSession(
            PreviewSchoolGradeLevelImportFromFileCommand input,
