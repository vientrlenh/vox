...
import com.sep.vox.application.port.input.command.CancelSubscriptionPlanCommand;
...
@Service
public class CancelSubscriptionPlanUseCase implements IUseCase<CancelSubscriptionPlanCommand, SchoolSubscriptionDto> {

    private final SchoolSubscriptionRepository schoolSubscriptionRepository;
    private final UserContextPort userContextPort;

    public CancelSubscriptionPlanUseCase(
    ...
    @Override
    @Transactional
    public SchoolSubscriptionDto execute(CancelSubscriptionPlanCommand input) {
