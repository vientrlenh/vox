...
// nếu gói hiện tại đã bị archive và được admin gán gói thay thế (xem PlanReplacementResolver),
...
public class PreviewRenewalUseCase implements IUseCase<PreviewRenewalQuery, RenewalPreviewDto> {
    ...
    public RenewalPreviewDto execute(PreviewRenewalQuery input) {
        ...
        var renewalPlan = PlanReplacementResolver.resolveActive(subscriptionPlanRepository, currentPlan);
