...
public class RubricCriterion {
    ...
    public RubricCriterion(UUID id, UUID rubricVersionId, String code, String name, String description,
    ...
    public RubricCriterion(UUID rubricVersionId, String code, String name, String description, BigDecimal weight,
            BigDecimal minScore, BigDecimal maxScore, int order, boolean isRequired, OffsetDateTime createdAt,
