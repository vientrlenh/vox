...
import com.sep.vox.domain.valueobject.scoringruleaction.CapStandardLevelParams;
...
import com.sep.vox.domain.valueobject.scoringruleaction.SetStandardLevelParams;
...
public final class ScoringRuleMapper {
    ...
    private static Class<? extends ScoringRuleActionParams> actionParamsType(ScoringRuleActionType type) {
        return switch (type) {
            ...
            case CAP_STANDARD_LEVEL -> CapStandardLevelParams.class;
            case SET_STANDARD_LEVEL -> SetStandardLevelParams.class;
