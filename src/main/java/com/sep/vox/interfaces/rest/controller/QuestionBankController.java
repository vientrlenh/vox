...
public class QuestionBankController {
    ...
    public ResponseEntity<ApiResponse<QuestionBankDto>> update(
        ...
        var command = new UpdateQuestionBankCommand(bankId, request.bankName(), request.description(), false);
        var data = updateQuestionBankUseCase.execute(command);
        return ResponseEntity.ok(ApiResponse.success("Cập nhật ngân hàng câu hỏi thành công", data));
    }
