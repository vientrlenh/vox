...
public class RecordExamAttemptEvaluationHumanGuardTests {
    ...
    void setUp() {
        ...
        useCase = new RecordExamAttemptEvaluationUseCase(
            ...
            transactionManager, jsonSerializationPort);
    ...
    private ExamAttemptEvaluationCompletedEventDto event() {
        var payload = new ExamAttemptEvaluationCompletedEventDto.PayloadDto(
            List.of(), Map.of(), null, null, "Khá", List.of(), "gpt-4o", "v1", null);
        return new ExamAttemptEvaluationCompletedEventDto(
