...
public class ChangeSchoolUserRoleUseCaseTests {
    ...
    void setUp() {
        ...
        changeSchoolUserRoleUseCase = new ChangeSchoolUserRoleUseCase(
            userContextPort, userRepository, roleRepository, userRoleRepository
        );
    }

    @Test
    void change_role_should_update_existing_user_role_row_in_place() {
        ...
        // verify update-in-place: the existing row's roleId is updated to teacherRoleId
