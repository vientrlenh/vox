...
public class AuthControllerTests {
    ...
    void login_should_return_ok_response() {
        ...
        var registerSchoolAdminUseCase = mock(RegisterSchoolAdminUseCase.class);
        var controller = new AuthController(loginUseCase, registerUseCase, registerSchoolAdminUseCase);
